    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 z-20 relative">
        <div className="text-center">
          {/* Main Heading */}
          <h1 className="break-words leading-tight pt-6 text-2xl xs:text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-jetbrains font-bold text-white mb-4 sm:mb-6 animate-fade-in relative z-30">
            AppTeam
          ...
          {/* Subtitle */}
          <p className="text-sm xs:text-base sm:text-lg md:text-xl font-inter text-gray-300 mb-6 sm:mb-8 max-w-xl mx-auto animate-fade-in relative z-30 px-2 leading-relaxed">
          ...
          {/* Stats */}
          <div className="flex flex-wrap justify-center gap-4 sm:gap-6 md:gap-8 mb-8 sm:mb-12 animate-fade-in relative z-30 px-2">
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-jetbrains font-bold text-neon-magenta">3</div>
              <div className="text-gray-400 font-inter text-xs sm:text-sm">Major Events</div>
            </div>
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-jetbrains font-bold text-vibrant-green">40+</div>
              <div className="text-gray-400 font-inter text-xs sm:text-sm">Active Members</div>
            </div>
          </div>

          {/* Event Badges */}
          <div className="flex flex-wrap justify-center gap-2 sm:gap-3 md:gap-4 mb-8 sm:mb-12 animate-fade-in relative z-30 px-2">
            <div className="px-3 sm:px-4 py-2 bg-electric-blue/20 border border-electric-blue/30 rounded-full backdrop-blur-sm">
              <span className="text-[11px] xs:text-xs sm:text-sm text-electric-blue font-jetbrains">HackOnHills</span>
            </div>
            <div className="px-3 sm:px-4 py-2 bg-neon-magenta/20 border border-neon-magenta/30 rounded-full backdrop-blur-sm">
              <span className="text-[11px] xs:text-xs sm:text-sm text-neon-magenta font-jetbrains">Nimbus</span>
            </div>
            <div className="px-3 sm:px-4 py-2 bg-vibrant-green/20 border border-vibrant-green/30 rounded-full backdrop-blur-sm">
              <span className="text-[11px] xs:text-xs sm:text-sm text-vibrant-green font-jetbrains">Hillfair</span>
            </div>
          </div>

          {/* CTA Buttons */}
          <div className="flex flex-col xs:flex-row gap-3 sm:gap-4 justify-center items-center animate-fade-in relative z-30 px-2">
            <GlowButton 
              className="group text-sm sm:text-base w-full xs:w-auto sm:w-auto md:w-fit text-center"
