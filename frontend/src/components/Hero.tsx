      ...
      <div className="container mx-auto px-4 sm:px-6 z-20 relative">
        <div className="text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 sm:gap-8 md:gap-12 mb-8 sm:mb-12 animate-fade-in relative z-30 px-2">
            <div className="text-center">
              <div className="text-2xl sm:text-3xl md:text-4xl font-space font-bold text-accent-primary">6+</div>
              <div className="text-muted-text font-inter text-xs sm:text-sm">Years Active</div>
            </div>
            <div className="text-center">
              <div className="text-2xl sm:text-3xl md:text-4xl font-space font-bold text-accent-secondary">3</div>
              <div className="text-muted-text font-inter text-xs sm:text-sm">Major Events</div>
            </div>
            <div className="text-center">
              <div className="text-2xl sm:text-3xl md:text-4xl font-space font-bold text-accent-tertiary">40+</div>
          ...
          <div className="flex flex-wrap justify-center gap-3 md:gap-4 mb-8 sm:mb-12 animate-fade-in relative z-30 px-2">
            <div className="px-4 py-2 bg-accent-primary/10 border border-accent-primary/30 rounded-full backdrop-blur-sm">
              <span className="text-xs sm:text-sm text-accent-primary font-inter font-medium">HackOnHills</span>
            </div>
            <div className="px-4 py-2 bg-accent-secondary/10 border border-accent-secondary/30 rounded-full backdrop-blur-sm">
              <span className="text-xs sm:text-sm text-accent-secondary font-inter font-medium">Nimbus</span>
            </div>
            <div className="px-4 py-2 bg-accent-tertiary/10 border border-accent-tertiary/30 rounded-full backdrop-blur-sm">
          ...
          <div className="flex flex-col xs:flex-row gap-4 justify-center items-center animate-fade-in relative z-30 px-2">
            <GlowButton 
              className="group text-sm sm:text-base w-full xs:w-auto"
          ...
          <div className="hidden lg:block absolute top-40 right-20 animate-float" style={{ animationDelay: '2s' }}>
            <Users className="w-8 h-8 text-accent-secondary/40" />
          </div>
          <div className="hidden lg:block absolute bottom-40 left-20 animate-float" style={{ animationDelay: '4s' }}>
            <div className="w-12 h-12 bg-gradient-to-br from-accent-primary/10 to-accent-tertiary/10 rounded-full backdrop-blur-sm"></div>
          </div>
          <div className="hidden lg:block absolute top-60 right-10 animate-pulse-glow">
            <Zap className="w-6 h-6 text-accent-tertiary/50" />
          </div>
        </div>
      </div>
    </section>
