      ...
      <div className="container mx-auto px-4 sm:px-6 z-20 relative">
        <div className="text-center">
          ...
          <h1 className="break-words leading-tight pt-6 text-3xl xs:text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-space font-bold text-primary-text mb-4 sm:mb-6 animate-fade-in relative z-30">
            AppTeam
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-accent-blue via-accent-plum to-accent-green">
              NIT Hamirpur
            </span>
          </h1>

          {/* Subtitle */}
          <p className="text-sm xs:text-base sm:text-lg md:text-xl font-inter text-secondary-text mb-6 sm:mb-8 max-w-2xl mx-auto animate-fade-in relative z-30 px-2 leading-relaxed">
          ...
          <div className="flex flex-wrap justify-center gap-6 sm:gap-8 md:gap-12 mb-8 sm:mb-12 animate-fade-in relative z-30 px-2">
            <div className="text-center">
              ...
              <div className="text-secondary-text font-inter text-xs sm:text-sm">Years Active</div>
            </div>
            <div className="text-center">
              <div className="text-2xl sm:text-3xl md:text-4xl font-space font-bold text-accent-plum">3</div>
              <div className="text-secondary-text font-inter text-xs sm:text-sm">Major Events</div>
            </div>
            <div className="text-center">
              <div className="text-2xl sm:text-3xl md:text-4xl font-space font-bold text-accent-green">40+</div>
              <div className="text-secondary-text font-inter text-xs sm:text-sm">Active Members</div>
            </div>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-3 md:gap-4 mb-8 sm:mb-12 animate-fade-in relative z-30 px-2">
            ...
            <div className="px-4 py-2 bg-accent-plum/10 border border-accent-plum/30 rounded-full backdrop-blur-sm">
              <span className="text-xs sm:text-sm text-accent-plum font-inter font-medium">Nimbus</span>
            </div>
            <div className="px-4 py-2 bg-accent-green/10 border border-accent-green/30 rounded-full backdrop-blur-sm">
              <span className="text-xs sm:text-sm text-accent-green font-inter font-medium">Hillfair</span>
            </div>
          </div>
          ...
          <div className="hidden lg:block absolute top-40 right-20 animate-float" style={{ animationDelay: '2s' }}>
            <Users className="w-8 h-8 text-accent-plum/40" />
          </div>
          <div className="hidden lg:block absolute bottom-40 left-20 animate-float" style={{ animationDelay: '4s' }}>
            <div className="w-12 h-12 bg-gradient-to-br from-accent-blue/10 to-accent-green/10 rounded-full backdrop-blur-sm"></div>
          </div>
          <div className="hidden lg:block absolute top-60 right-10 animate-pulse-glow">
            <Zap className="w-6 h-6 text-accent-green/50" />
          </div>
        </div>
      </div>
    </section>
