      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-space font-bold text-white mb-4 md:mb-6">
            About <span className="text-accent-blue">AppTeam</span>
          </h2>
          <p className="text-base md:text-xl font-inter text-neutral-medium max-w-4xl mx-auto leading-relaxed">
        ...
        <GlassCard className="p-6 md:p-8 mb-12 md:mb-16 text-center">
          <h3 className="text-xl md:text-2xl font-space font-semibold text-white mb-4">
            Our <span className="text-accent-purple">Mission</span>
          </h3>
          <p className="text-base md:text-lg font-inter text-neutral-medium leading-relaxed max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {values.map((value, index) => (
            <GlassCard key={index} className="p-6 text-center group">
              ...
              <h3 className="text-lg font-space font-semibold text-white mb-3 group-hover:text-accent-blue transition-colors duration-300">
                {value.title}
              </h3>
              <p className="text-neutral-medium font-inter text-sm leading-relaxed">
                {value.description}
              </p>
            </GlassCard>
          ))}
        ...
        <div className="mt-12 md:mt-16">
          <GlassCard className="p-6 md:p-8">
            <h3 className="text-xl font-space font-semibold text-white mb-6 text-center">
              Our Development <span className="text-accent-teal">Philosophy</span>
            </h3>
            <div className="bg-secondary-dark/50 rounded-lg p-6 border border-glass-border">
              <pre className="text-sm font-mono text-neutral-medium overflow-x-auto">
                <code>
{`class AppTeamNITH {
  constructor() {
